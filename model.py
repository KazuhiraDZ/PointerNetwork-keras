...
from models.attendgru_sml import AttentionGRUModel as AttentionGRUModelsml
def create_model(modeltype, config=None):
    mdl = None
    ...
    if modeltype == 'attendgru':
        ...
        mdl = xtra(config)
    elif modeltype == 'attendgru-sml':
        mdl = AttentionGRUModelsml(config)
    else:
